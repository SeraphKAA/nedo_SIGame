...
namespace Guess_the_melody
{
    public partial class Form1 : Form
    {
        ...
        private List<string> soundsAllPaths = new List<string>();
        private List<Button> chooseButtons = new List<Button>();

        private bool isStarted = false;

        private System.Media.SoundPlayer snd = null;
        ...
        private void InVis()
        {
            ...
            back_to_persons_Button.Visible = false;
        }

        private void InVis_persons() 
        {
        ...
        {
            back_to_persons_Button.Visible = true;
        ...
        private void back_to_persons_Button_Click(object sender, EventArgs e)
        {
            InVis();
